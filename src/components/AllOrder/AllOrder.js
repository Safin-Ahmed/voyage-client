...
const AllOrder = ({ order, orders, setOrders }) => {
    ...
    return (
        <tr>
            ...
            <td data-label="Action"><button onClick={handleCancel} className="btn btn-danger text-white cancel-btn me-3">Decline</button><button onClick={handleAccept} className="btn btn-success text-white cancel-btn">Accept</button></td>
        </tr>
    );
};
